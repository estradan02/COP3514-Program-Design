//Program by Nicholas Estrada. This program is designed to emulate a dice being rolled a specific amount of times determined by the user, along with reading the number of faces of the dice.
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
int main(void)
{
	...
	int roll, num_rolls, count = 0, total_rolls, num_faces;
